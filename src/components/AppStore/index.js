...
class AppStore extends Component {
  ...
  render() {
    const searchingresult = this.getSearchResult()
    const filterItemTabList = this.filterTheTabItem(searchingresult)

    return (
      <div className="bg_container_appstore">
        <div className="min_container_appstore">
          <h1>App Store</h1>
          <input
            type="Search"
          ...
          />
          <div>
            <ul className="tab_container_appstore">
          ...
          <div>
            <ul className="tab_item_the_catergory">
              {filterItemTabList.map(eachAppList => (
                <AppItem
                  key={eachAppList.appId}
                  AppItemDetails={eachAppList}
                  updateActiveTabItem={this.updateActiveTabItem}
                />
              ))}
            </ul>
